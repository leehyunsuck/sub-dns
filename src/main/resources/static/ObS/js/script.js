...
//   script.async = true;
//   script.src = 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3480088971158917';
...
// }
//
// function shouldLoadAds(page) {
//   const allowedPages = [
//     'domainSearch' // 메인 검색 페이지
//   ];
//
...
async function loadPage(page) {
  try {
    // seo 조각 제거
    // const seo = document.getElementById('seo-default');
    // if (seo) {
